...
import { Users, Sparkles, Code2, Settings, HelpCircle } from 'lucide-react';
...
export default function Personalia({}: PersonaliaProps) {
  return (
    <div className="space-y-8 font-sans text-slate-800 p-2">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-150 pb-6">
        <div>
          <div className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-xl bg-teal-500/10 border border-teal-500/20 text-teal-700 flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-slate-550 text-xs mt-0.5">
                Pencatatan data pegawai ASN, Non-ASN, petugas pintu air, kenaikan pangkat, mutasi berkas, serta jadwal piket dinas.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative overflow-hidden bg-slate-50 border border-dashed border-slate-300 rounded-3xl p-8 md:p-12 text-center shadow-xs">
        ...
        <div className="relative max-w-lg mx-auto space-y-6">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-teal-500/10 border border-teal-200 text-teal-700 text-[10px] font-black uppercase tracking-widest animate-pulse mx-auto">
          ...
          <div className="space-y-2">
            <h2 className="text-lg font-extrabold text-slate-900 tracking-tight">
              Seksi Kepegawaian & Personalia Kosong
            </h2>
            <p className="text-xs text-slate-550 leading-relaxed max-w-md mx-auto">
              Halaman ini telah dikosongkan secara permanen dari dummy data bawaan. Anda dapat meminta penambahan form biodata staf, modul penghitungan pensiun dini, pencatatan berkas kepangkatan PNS, atau jadwal absensi jaga bendung.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 text-left shadow-2xs">
            <h4 className="text-xs font-bold text-slate-800 uppercase tracking-wide mb-3 flex items-center gap-1.5">
              ...
              <span>Gagasan Kustomisasi Personalia & Pegawai:</span>
            </h4>
            <ul className="space-y-2.5 text-xs text-slate-650">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Database Pegawai & NIP</strong>: Form input profil pekerja (PNS & Honorer), pangkat golongan, jabatan teknis, dan informasi kontak darurat.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-sky-500 mt-1.5 shrink-0" />
                <span><strong>Monitoring Kenaikan Pangkat berkala</strong>: Sistem pengingat waktu (reminders) kelayakan naik pangkat ASN per 4 tahun sekali.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-amber-500 mt-1.5 shrink-0" />
                <span><strong>Piket Jaga & Absensi</strong>: Pembagian tugas shift penjaga pintu air dan koordinator lapangan seksi OP.</span>
              </li>
            </ul>
          </div>
