...
export const defaultProfile: InstansiProfile = {
  name: 'UPTD PSDA Bah Bolon Dinas PUPR Provinsi Sumatera Utara',
  ...
  footerText: 'Sistem Informasi Administrasi Terpadu UPTD Pengelolaan Sumber Daya Air Bah Bolon - Dinas Pekerjaan Umum dan Penataan Ruang',
  copyrightText: '© 2026 UPTD PSDA Bah Bolon. All Rights Reserved.'
};
